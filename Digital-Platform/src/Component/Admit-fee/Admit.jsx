...
const Admit = () => {
  ...
  <div className="card-body">
    <div className="">
      ...
      <span className=""><span className='font-bold text-[40px]'>$0</span>/month</span>
    </div>
    ...
    <div className="mt-6">
      <button className="btn bg-indigo-500 btn-block rounded-2xl">Get Started Free</button>
    </div>
  </div>
            </div>

            <div className="card bg-base-100 shadow-sm bg-indigo-600">
  <div className="card-body">
    <div className="">
      <h2 className="text-[24px] font-bold text-white">Pro</h2>
      <p className='text-[#8b939b]'>Best for professionals</p>
      <span className="text-white"><span className='font-bold text-[40px]'>$29</span>/month</span>
    </div>
    <ul className="mt-6 flex flex-col gap-2 text-xs">
      <li>
        <svg xmlns="http://www.w3.org/2000/svg" className="size-4 me-2 inline-block text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
    ...
    <div className="mt-6">
      <button className="btn bg-white text-indigo-600 btn-block rounded-2xl">Start Pro Trial</button>
    </div>
  </div>
            </div>
  ...
  <div className="card-body">
    <div className="">
      ...
      <span className=""><span className='font-bold text-[40px]'>$99</span>/month</span>
    </div>
    <ul className="mt-6 flex flex-col gap-2 text-xs">
      <li>
        <svg xmlns="http://www.w3.org/2000/svg" className="size-4 me-2 inline-block text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
    ...
    <div className="mt-6">
      <button className="btn bg-indigo-500 btn-block rounded-2xl">Contact Sales</button>
    </div>
  </div>
            </div>
