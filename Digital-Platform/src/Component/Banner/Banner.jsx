...
const Banner = () => {
    return (
        <div>
            <div className="flex justify-center items-center p-30 gap-10 bg-base-200 min-h-screen">
    ...
    <div className='space-y-3'>
      ...
      <h1 className="text-5xl font-bold leading-13 ">Supercharge Your<br></br>Digital Workflow</h1>
